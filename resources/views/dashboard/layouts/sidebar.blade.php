<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href=""{{route('dashboard.dashboard')}}""><i class="icon-speedometer"></i> dashboard </a>
            </li>

             <li class="nav-item">
                <a class="nav-link" href="{{route('dashboard.customers.index')}}"><i class="icon-people"></i> Customers</a>
            </li>
